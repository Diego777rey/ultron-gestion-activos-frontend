...
@Component({
  selector: 'app-categoria-servicio-rapida-form',
  ...
  template: `
    ...
    <form class="form" [formGroup]="form" (ngSubmit)="onSubmit()">
      <div class="field">
        ...
        <input id="cat-nombre" class="field__input" type="text" formControlName="nombre" appAutofocus appUppercase placeholder="Ej: MECÁNICA" />
...
export class CategoriaServicioRapidaFormComponent {
  private readonly fb = inject(FormBuilder);
  private readonly categoriaService = inject(CategoriaServicioService);
  readonly dialogRef = inject(DialogRef<CategoriaServicioOutput | undefined>, { optional: true });
